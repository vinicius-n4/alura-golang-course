...
// var temp recebe todos os templates
// Must() encapsula os templates e retorna o template e um erro
// ParseGlob() recebe o path dos templates
var temp = template.Must(template.ParseGlob("templates/*.html"))

// função que é chamada na rota "/" e carrega o template "Index" com os itens do DB
